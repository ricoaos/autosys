    ...
    $.sprFlat = function(element, options) {
        ...
        var defaults = {
            ...
            sidebar: {
                ...
                pinnedSearch: true// make search to be pinned into top
            },
            sideNav : {
                flyout: true, //make flyout menu
                ...
                showSubPlus: {
                    showPlus: true,//Show plus icon instead of arrow to indicate sub
                    sideNavPlusIcon: 'en-plus3',//icon for expand state of submenu
                    sideNavMinusIcon: 'en-minus3'//icon for closed state of submenu
                },
                ...
                autoCurrentSystem: {
                    active: true,//set on or off the auto current system via javascript
        ...
        plugin.init = function() {
            ...
            if (plugin.settings.sideNav.autoCurrentSystem.active) {
                this.setCurrentNav();
            }
            //toggle sidebar
            this.toggleSidebar();
            ...
            //pinned search
            if(plugin.settings.sidebar.pinnedSearch) {
                $('#sideNav').addClass('pinnedSearch');
                $('.panel-nav-header').addClass('pinnedSearch');
            }

            //handle collapse button on sidebar
            this.collapseSubButton();
        ...
        plugin.sideBarNav = function() {
            ...
            if(plugin.settings.sideNav.showSubArrow.showArrows) {
                plugin.showArrows(true);
            } else if (plugin.settings.sideNav.showSubPlus.showPlus) {
                plugin.showPlus(true);
            }

            if (plugin.settings.sideNav.flyout) {
                plugin.flyoutMenu(true);
            }

            //check if sub is expanded by user wish
            navSub.each(function(index) {
                _this = $(this);
                if (_this.hasClass('show')) {
                    ael =  _this.prev('a');
                    ael.addClass('expand').removeClass('notExpand');
                    if(plugin.settings.sideNav.showArrows) {
                        ael.find('.sideNav-arrow').transition({rotate: '-180deg'});
                        setTimeout(function(){
                             ael.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.sideNavPlusIcon).addClass(plugin.settings.sideNav.sideNavMinusIcon);
                        }, 150);
                    }
                }
            });
                ...
                navLink.on("click", function(e){
                    ...
                    if(_this.hasClass('notExpand')) {
                        ...
                        if (plugin.settings.sideNav.flyout) {                            
                            ...
                            //check for open sub first
                            navLink.each(function(index) {
                                if ($(this).hasClass('expand')) {
                                    $(this).removeClass('expand').addClass('notExpand');
                                    $(this).closest('li.click-it').not('li.hover-li').removeClass('click-it');
                                }
                            });

                            //show the sub
                            _this.closest('li.hasSub').addClass('click-it');
                            _this.next('ul').addClass('show');
                            _this.addClass('expand').removeClass('notExpand');
                            ...
                            if(plugin.settings.sideNav.showSubArrow.showArrows) {
                                ...
                                _this.find('.sideNav-arrow').transition({rotate: '-180deg'});
                                setTimeout(function(){
                                     _this.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.showSubPlus.sideNavPlusIcon).addClass(plugin.settings.sideNav.showSubPlus.sideNavMinusIcon);
                                }, 150);
                            }
                        }                 
                        ...
                        e.preventDefault();
                        if (plugin.settings.sideNav.flyout) {
                            _this.closest('li.hasSub').removeClass('click-it');
                            _this.next('ul').removeClass('show');
                            _this.addClass('notExpand').removeClass('expand');
                        } else {
                            ...
                            if(plugin.settings.sideNav.showSubArrow.showArrows) {
                                ...
                                _this.find('.sideNav-arrow').transition({rotate: '0deg'});
                                setTimeout(function(){
                                    _this.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.showSubPlus.sideNavMinusIcon).addClass(plugin.settings.sideNav.showSubPlus.sideNavPlusIcon);
                                }, 150);
                            }
                        }
                    }
        ...
        plugin.showArrows = function (val) {
            var nav = $('#sideNav');
            var navSub = nav.find('li>ul.sub');
            ...
            if (val == true) {
                ...
                if (plugin.settings.sideNav.flyout) {
                    if(!navSub.prev('a').find('i.sideNav-arrow').length) {
                        navSub.prev('a').prepend('<i class="'+ plugin.settings.sideNav.showSubArrow.sideNavArrowIcon + ' sideNav-arrow"></i>');
                        navSub.prev('a').find('.sideNav-arrow').transition({rotate: '-90deg'},0);
                    }
                } else {
                    if(!navSub.prev('a').find('i.sideNav-arrow').length) {
                        navSub.prev('a').prepend('<i class="'+ plugin.settings.sideNav.showSubArrow.sideNavArrowIcon + ' sideNav-arrow"></i>');
                ...
                $('#sideNav').removeClass('show-arrows');
                navSub.prev('a').find('i.sideNav-arrow').remove();
            }
        }

        plugin.showPlus = function (val) {
            var nav = $('#sideNav');
            var navSub = nav.find('li>ul.sub');
            ...
            if (val == true) {
                ...
                if (plugin.settings.sideNav.flyout) {
                    if(!navSub.prev('a').find('i.sideNav-arrow').length) {
                        navSub.prev('a').prepend('<i class="'+ plugin.settings.sideNav.showSubPlus.sideNavPlusIcon + ' sideNav-arrow"></i>');
                    }
                } else {
                    if(!navSub.prev('a').find('i.sideNav-arrow').length) {
                        navSub.prev('a').prepend('<i class="'+ plugin.settings.sideNav.showSubPlus.sideNavPlusIcon + ' sideNav-arrow"></i>');
        ...
        //make or destroy flyout menu
        plugin.flyoutMenu = function (val) {
            var nav = $('#sideNav');
            
            if (val == true ) {
                //create menu
                nav.addClass('flyout');
                //plugin.showArrows(false);
            } else {
                //destroy menu
                nav.removeClass('flyout');
                //plugin.showArrows(true);
            }
        }
        ...
        plugin.setCurrentNav = function () {
            ...
            if(domain === '') {
                ...
                if(plugin.settings.sideNav.autoCurrentSystem.absoluteUrl) {
                    ...
                    if(plugin.settings.sideNav.autoCurrentSystem.subDir != ''){
                        var afterDomain = window.location.pathname + plugin.settings.sideNav.autoCurrentSystem.subDir;
                    }
            ...
            mainNavLinkAll.each(function(index) {
                ...
                if(href === url) {
                    ...
                    if(ulElem.hasClass('sub')) {
                        ...
                        if(plugin.settings.sideNav.showArrows && !plugin.settings.sideNav.flyout) {
                            _this.find('.sideNav-arrow').transition({rotate: '-180deg'}, 0);
                            setTimeout(function(){
                                _this.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.sideNavPlusIcon).addClass(plugin.settings.sideNav.sideNavMinusIcon);
                            }, 150);
                        }
                    } 
                } else {
        ...
        plugin.backToTop = function () {
            ...
            (function(e){e.fn.goup=function(t){e.fn.goup.defaultOpts={appear:200,scrolltime:800,imgsrc:"../../assets/img/backtop.png",width:72,place:"bottom-right",fadein:500,fadeout:500,opacity:.5,marginX:2,marginY:2};var n=e.extend({},e.fn.goup.defaultOpts,t);return this.each(function(){var t=e(this);t.html("<a><img /></a>");var r=e("#goup a");var i=e("#goup a img");t.css({position:"fixed",display:"block",width:"'"+n.width+"px'","z-index":"9"});r.css("opacity",n.opacity);i.attr("src",n.imgsrc);i.width(n.width);i.hide();e(function(){e(window).scroll(function(){if(e(this).scrollTop()>n.appear)i.fadeIn(n.fadein);else i.fadeOut(n.fadeout)});e(r).hover(function(){e(this).css("opacity","1.0");e(this).css("cursor","pointer")},function(){e(this).css("opacity",n.opacity)});e(r).click(function(){e("body,html").animate({scrollTop:0},n.scrolltime);return false})});if(n.place==="top-right")t.css({top:n.marginY+"%",right:n.marginX+"%"});else if(n.place==="top-left")t.css({top:n.marginY+"%",left:n.marginX+"%"});else if(n.place==="bottom-right")t.css({bottom:n.marginY+"%",right:n.marginX+"%"});else if(n.place==="bottom-left")t.css({bottom:n.marginY+"%",left:n.marginX+"%"});else t.css({bottom:n.marginY+"%",right:n.marginX+"%"})})}})(jQuery);
...
-1*delta}if(orgEvent.wheelDeltaY!==undefined)deltaY=orgEvent.wheelDeltaY/120;if(orgEvent.wheelDeltaX!==undefined)deltaX=-1*orgEvent.wheelDeltaX/120;args.unshift(event,delta,deltaX,deltaY);return($.event.dispatch||$.event.handle).apply(this,args)}})(jQuery);
        ...
        plugin.respondjs = function () {
            ...
            jRes.addFunc({
                breakpoint: 'small',
                enter: function() {
                    if (plugin.settings.sideNav.flyout) {plugin.flyoutMenu(false);}
                    plugin.hideLeftSidebar();
                    plugin.dropdownMenuFix();
                    plugin.collapseEmailAppSidebar();
                    $('#email-content').addClass('email-content-offCanvas');
                ...
                exit: function() {
                    if (plugin.settings.sideNav.flyout) {plugin.flyoutMenu(true);}
                    plugin.showLeftSidebar();
                    $('#email-content').removeClass('email-content-offCanvas');
                }
            });
        ...
        //collapse Sub button event
        plugin.collapseSubButton = function () {
            var oexpsubs = $('#expand-all-submenus');
            var icon = oexpsubs.find('i');
            //expand subs handle
        ...
        plugin.expandSideBarNav = function () {
            ...
            if(plugin.settings.sideNav.showSubPlus.showPlus) {
                nava.find('.sideNav-arrow').transition({rotate: '-180deg'});
                nava.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.showSubPlus.sideNavPlusIcon).addClass(plugin.settings.sideNav.showSubPlus.sideNavMinusIcon);
            }
        }
        ...
        plugin.collapseSideBarNav = function () {
            ...
            if(plugin.settings.sideNav.showSubPlus.showPlus) {
                nava.find('.sideNav-arrow').transition({rotate: '0deg'});
                nava.find('.sideNav-arrow').removeClass(plugin.settings.sideNav.showSubPlus.sideNavMinusIcon).addClass(plugin.settings.sideNav.showSubPlus.sideNavPlusIcon);
            }
        }
