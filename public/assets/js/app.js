    ...
    hljs.initHighlightingOnLoad();
 	...
 	$('body').sprFlat({
        ...
        sidebar: {
            ...
            pinnedSearch: false// make search to be pinned into top
        },
        sideNav : {
            flyout: false, //make flyout menu ,please put sidebar fixed to false in order to work.
            hover: false, //shows subs on hover or click
            showNotificationNumbers: 'onhover',//show how many elements menu have with notifcation style values - always, onhover, never4
            showSubArrow: {
            ...
            showSubPlus: {
                ...
                sideNavPlusIcon: 'en-plus3 s16',//icon for expand state of submenu
                sideNavMinusIcon: 'en-minus3 s16'//icon for closed state of submenu
            },
